...
$(document).ready(function(){
  $('.owl-carousel-index').owlCarousel({
      ...
      nav: true,
      margin: 70,
      navText : ["<div class='owl-next'><img src='assets/images/sample/right-bg-slide.svg' width='54px'></div>","<div class='owl-prev'><img src='assets/images/sample/left-bg-slide.svg' width='54px'></div>"],
      responsive:{
        0:{
            items:1
        },
...
//      autoplayTimeout: 5000,
      nav: true,
      margin: 10,
      navText : ["<div class='owl-next'><img src='assets/images/sample/right-2.svg' width='54px'></div>","<div class='owl-prev'><img src='assets/images/sample/left-2.svg' width='54px'></div>"],
      responsive:{
        0:{
            items:1
        },
