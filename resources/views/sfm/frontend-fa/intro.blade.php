...
<div class="intro noselect">
    <div class="container">
        <a href="/brand/luxtai" class="introbox"><img src="/{{env('THEME_NAME')}}/assets/images/luxtai.png"
                                                      draggable="false"></a>
        <a href="/brand/komtai" class="introbox"><img src="/{{env('THEME_NAME')}}/assets/images/komtai.png"
                                                      draggable="false"></a>
        <a href="/brand/expanse" class="introbox"><img src="/{{env('THEME_NAME')}}/assets/images/expanse.png"
                                                       draggable="false"></a>
        <div class="introbox oembox">
            <div class="indexuner"><h2>OEM</h2>
                <h3>محصول مورد نظر خودرا انتخاب نمایید</h3></div>
        </div>
    </div>
</div>
