...
<div class="khat"><span>COLORS:</span> White, Black, Gray, Silver<div class="colors"><div class="color white"></div><div class="color black"></div><div class="color gray"></div><div class="color silver"></div></div></div>
...
<div class="singleproductimg"><div><img src="/{{env('THEME_NAME')}}/assets/images/main-product.png" draggable="false"></div></div>
</div>
...
@foreach($same_products as $same_product)
	<div class="product micro1 active">
		...
		<a href="{{route('frontend.product.show',['slug' => $same_product->slug])}}" class="productmore">VIEW MORE</a>
	</div>
